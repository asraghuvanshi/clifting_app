...
import 'package:clifting_app/presentation/features/auth/presentation/screen/webview_screen.dart';
import 'package:clifting_app/presentation/features/profile/data/model/user_profile_model.dart';
import 'package:clifting_app/presentation/features/profile/providers/profile_provider.dart';
  ...
  Widget _buildMainMenuOptions() {
    final menuItems = [
      ...
      _MenuItem(
        ...
        onTap: () {}
        // => _navigateToWebView('Privacy Policy', 'privacy'),
      ),
      _MenuItem(
